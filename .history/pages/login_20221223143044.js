...
function login() {
  ...
  const submit = (e) => {
    ...
    const data = { email, password  };
      ...
      let res = fetch('http://localhost:3000/api/login', {
      method: 'POST',
      headers: {
      ...
      .then((data) => {
        ...
        setPassword('')
        setConfirmpassword('')
        toast.success('You are succesfully Logined.!', { position: "bottom-center", autoClose: 1000, hideProgressBar: false, closeOnClick: true, pauseOnHover: true, draggable: true, progress: undefined, theme: "light", });
    ...
    <div className="min-h-screen bg-gray-100 flex flex-col justify-center sm:py-12">
        ...
        <ToastContainer position="bottom-center" autoClose={1000} hideProgressBar={false} newestOnTop={false} closeOnClick rtl={false} pauseOnFocusLoss draggable pauseOnHover theme="light"/>
            ...
            <div className="px-5 py-7">
                ...
                <input onChange={handleChange} value={password} name="password" id='password' type="text" className="bg-gray-100 bg-opacity-50 resize-none text-gray-700 outline-none border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full transition-colors duration-200 ease-in-out" />


                <button type="button" className="w-full text-center py-3 bg-blue-700 text-white rounded-xl font-semibold hover:bg-blue-800 focus:outline-none my-1">
