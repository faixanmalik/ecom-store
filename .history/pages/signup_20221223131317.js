  ...
  const submit = (e) => {
    ...
    const data = { firstname, lastname, email, password, confirmpassword };
      ...
      .then((data) => {
        ...
        setPassword('')
        setConfirmpassword('')
        toast.success('🦄 Wow so easy!', { position: "bottom-center", autoClose: 1000, hideProgressBar: false, closeOnClick: true, pauseOnHover: true, draggable: true, progress: undefined, theme: "light", });
