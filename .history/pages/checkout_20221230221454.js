      ...
      <div className="lg:w-full mx-auto">
        <div className="flex flex-wrap -m-2">
          ...
          <form method='POST' onSubmit={submit}>
            ...
            <button type='submit' className='bg-blue-600 mt-4 px-5 py-2 flex rounded text-white'><AiOutlineShopping className='my-auto mx-2'/><Link href={'order'}></Link>Pay ${subTotal}</button>
