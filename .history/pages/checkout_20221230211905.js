...
function Checkout({cart , subTotal, removeFromCart, addToCart }) {
  ...
  <section className="text-gray-600 body-font relative">
    <div className="container px-5 py-24 mx-auto w-9/12">
      ...
      <Link href={"/order"}><button type='submit' className='bg-blue-600 mt-4 px-5 py-2 flex rounded text-white'><AiOutlineShopping className='my-auto mx-2'/>Pay ${subTotal}</button></Link>
