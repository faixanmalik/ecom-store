        ...
        <div className="flex flex-wrap -m-2">
          ...
          <form method='POST' onSubmit={submit}>
            ...
            <div className="relative">
              ...
              <input onChange={handleChange} value={streetAddress} type="text" name="street-address" id="street-address" autoComplete="street-address" className="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"/>
            </div>
            </div>
            <div className='w-full md:flex'>
              <div className="p-2 md:w-1/3">
                <div className="relative">
                  ...
                  <input onChange={handleChange} value={city} type="text" id="firstname" name="firstname" className="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"/>
                </div>
              </div>
              <div className="p-2 md:w-1/3">
                <div className="relative">
              ...
              <div className="p-2 md:w-1/3">
                <div className="relative">
                  ...
                  <input onChange={handleChange} value={zip} type="text" id="lastname" name="lastname" className="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"/>
                </div>
              </div>
            </div>
