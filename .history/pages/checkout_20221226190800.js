    ...
    <div className="container px-5 py-24 mx-auto w-9/12">
      ...
      <div className="lg:w-full mx-auto">
        <div className="flex flex-wrap -m-2">
          ...
          <div className="p-2 w-full">
          <div className="relative">
            <label htmlhtmlFor="country" className="leading-7 text-sm text-gray-600">Country:</label>
          ...
          <div className="p-2 w-full">
          <div className="relative">
            <label htmlhtmlFor="street-address" className="leading-7 text-sm text-gray-600">Street address:</label>
