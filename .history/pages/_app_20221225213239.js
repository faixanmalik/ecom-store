...
//  react top loading bar
  ...
  return <>
  {/* <LoadingBar color='#0035FF' progress={progress} waitingTime={300} onLoaderFinished={() => setProgress(0)}/> */}
  <LoadingBar color='#007af' progress={progress} waitingTime={300} onLoaderFinished={() => setProgress(0)}/>
  <LoadingBar color='#007af' progress={progress} waitingTime={300} onLoaderFinished={() => setProgress(0)}/>
