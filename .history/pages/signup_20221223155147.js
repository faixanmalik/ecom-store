  ...
  const submit = async (e) => {
    ...
    const data = { firstname, lastname, email, password, confirmpassword };
      ...
      .catch((error) => {
        ...
        toast.error(error, { position: "bottom-center", autoClose: 1000, hideProgressBar: false, closeOnClick: true, pauseOnHover: true, draggable: true, progress: undefined, theme: "light", });
      });
