      ...
      <div className="flex flex-wrap lg:px-20 space-y-20">
        ...
        {/* {Object.keys(Product).map((item)=>{ */}
          <div className="w-60 mx-auto">
              <Link href={"/product/details"}><img alt="ecommerce" className="w-full h-80 block" src="https://static-01.daraz.pk/original/dafc774611f87ff8db4baefa9013bb52.jpg"/></Link>
