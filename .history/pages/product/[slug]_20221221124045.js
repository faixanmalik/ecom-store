              ...
              <div className="flex ml-6 items-center">
                ...
                <div className="relative">
                  <select className="rounded border appear`{nce-none py-2 focus:outline-none focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500 text-base }`l-3 pr-10">
                    ...
                    {Object.keys(variants[color]).includes ('S') && <option>M</option>}
                    {Object.keys(variants[color]).includes ('S') && <option>L</option>}
                    {Object.keys(variants[color]).includes ('S') && <option>XL</option>}
