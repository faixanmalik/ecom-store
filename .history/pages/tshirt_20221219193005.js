  ...
  return (
    ...
    <div className="container px-5 pt-5 pb-20 mx-auto">
      <div className="flex flex-wrap lg:px-20 space-y-20">
        ...
        {Object.keys(product).map((k,title,k.price)=>{
          return <div key={k.toString(k._id)} className="w-60 mx-auto">
              ...
              <div className="mt-4 text-center sm:text-left">
                <h3 className="text-gray-500 text-xs tracking-widest title-font mb-1">{k.title}</h3>
