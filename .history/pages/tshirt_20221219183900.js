    ...
    <div className="container px-5 pt-5 pb-20 mx-auto">
      <div className="flex flex-wrap lg:px-20 space-y-20">
        ...
        {Object.keys(Product).map((item)=>{
          return <Link key={Product._id} href={"/product/details"}>
          <div className="w-60 mx-auto">
            <div className="block h-72 rounded overflow-hidden">
              <img alt="ecommerce" className="w-full h-full block" src="https://static-01.daraz.pk/original/dafc774611f87ff8db4baefa9013bb52.jpg"/>
            </div>
