...
function Order({subTotal, cart }) {
  ...
  <div class="container px-5 py-24 mx-auto">
    <div class="lg:w-4/5 mx-auto flex flex-wrap">
      ...
      <div className='mb-10'>
        <div class="flex w-full border-b-2 border-gray-200 py-2">
          <div class="w-1/3 text-center text-gray-500">{item.title}</div>  
          <div class="w-1/3 text-center text-gray-900">3</div>
          <div class="w-1/3 text-center text-gray-900">300</div>
        </div>
        <div class="flex w-full border-b-2 border-gray-200 py-2">
          <div class="w-1/3 text-center text-gray-500">Mugs</div>  
          <div class="w-1/3 text-center text-gray-900">3</div>
          <div class="w-1/3 text-center text-gray-900">500</div>
        </div>
        <div class="flex w-full border-b-2 border-gray-200 py-2">
          <div class="w-1/3 text-center text-gray-500">Hoodies</div>  
          <div class="w-1/3 text-center text-gray-900">3</div>
          <div class="w-1/3 text-center text-gray-900">1000</div>
        </div>
