      ...
      <div className="flex flex-wrap lg:px-20 space-y-20">
        ...
        {product.map((item)=>{
          return <div key={item.toString(item._id)} className="w-60 mx-auto">
              <Link href={`/product/${item.slug}`}><img alt="ecommerce" className="w-full h-72 block" src="https://static-01.daraz.pk/original/dafc774611f87ff8db4baefa9013bb52.jpg"/></Link>
