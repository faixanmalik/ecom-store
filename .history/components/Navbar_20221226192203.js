  ...
  return (
    <header className="text-gray-600 body-font border-b-2 ">
        <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
            ...
            <div className="z-10">
              <div ref={ref} className="pt-3 overflow-scroll cart rounded-lg absolute top-0 right-0 bg-blue-100 px-7 w-1/3 h-full transform transition-transform translate-x-full">
                ...
                <div>
                  <ol className="pt-7 list-decimal font-medium text-red-800 space-y-2">
                    ...
                    {Object.keys(cart).map((k)=>{  return localStorage.getItem('token') && <li  key={k} className="text-lg text-blue-800">
                      ...
                      <button className='cursor-text text-blue-800 text-xl py-2 rounded'>SubTotal: ${subTotal}</button>
                  </ol>
