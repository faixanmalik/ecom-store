    ...
    <header className="text-gray-600 body-font border-b-2 ">
        <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
            ...
            <nav className="md:ml-auto md:mr-auto flex flex-wrap items-center text-lg md:text-xl justify-center list-none space-x-8 md:space-x-3 lg:space-x-8">
              <Link href={"/"}><li className='hover:text-blue-700 hover:font-medium'>Home</li></Link> 
              <Link href={"/tshirt"}><li className='hover:text-blue-700 hover:font-medium'>T-Shirts</li></Link> 
              <Link href={"/hoodies"}><li className='hover:text-blue-700 hover:font-medium'>Hoodies</li></Link>
              <Link href={"/mugs"}><li className='hover:text-blue-700 hover:font-medium'>Mugs</li></Link>
            </nav>
