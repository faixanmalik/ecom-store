  ...
  return (
    <header className="text-gray-600 body-font border-b-2 ">
        <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
            ...
            <div className='inline-flex items-center mt-4 md:mt-0 space-x-8 md:space-x-5'>
              
              {user.value && <BiUserCircle className='text-2xl cursor-pointer'/>}
              ...
              <Menu as="div" className="relative inline-block text-left">
                ...
                <Transition as={Fragment} enter="transition ease-out duration-100" enterFrom="transform opacity-0 scale-95" enterTo="transform opacity-100 scale-100" leave="transition ease-in duration-75" leaveFrom="transform opacity-100 scale-100" leaveTo="transform opacity-0 scale-95"></Transition>
