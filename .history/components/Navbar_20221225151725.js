    ...
    <header className="text-gray-600 body-font border-b-2 ">
        <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
            ...
            <div className='inline-flex items-center mt-4 md:mt-0 space-x-8 md:space-x-5 lg:space-x-8'>
              ...
              {user.value && <BiUserCircle className='text-xl cursor-pointer'/>}
            ...
            <div className="z-10">
              ...
              <div ref={ref} className="pt-3 overflow-y-scroll scroll-smooth cart rounded-lg absolute top-0 right-0 bg-blue-100 px-7 w-96 h-full transform transition-transform translate-x-full">
