              ...
              <div ref={ref} className="pt-3 overflow-scroll cart rounded-lg absolute top-0 right-0 bg-blue-100 px-7 w-2/5 h-full transform transition-transform translate-x-full">
                ...
                <div>
                  <ol className="pt-7 list-decimal font-medium text-red-800 space-y-2">
                    ...
                    {Object.keys(cart).map((item)=>{  return localStorage.getItem('token') ? <li  key={item} className="text-lg text-blue-800">
                    ...
                    </li>  :  <h1 key={item} className='text-center text-xl'>Please login to see your cart! </h1>  })}
                  </ol>

                  {(localStorage.getItem('token')) && <div className='flex space-x-3 pt-20'>
